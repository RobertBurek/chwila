package com.example.developers.cotroller;

import com.example.developers.modules.Student;
import com.example.developers.repository.StudentRepository;
...
public class StudentResource {
    ...
    public ResponseEntity<Student> createStudent(@RequestBody Student student) throws URISyntaxException {
        ...
        if (student.getId() != null) {
            try {
                throw new Exception("A new student cannot already have an ID");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
